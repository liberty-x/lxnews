...
test('9 photos', function(assert) {
    var done = assert.async();
    setTimeout (function(){
    var instagram = document.getElementsByClassName("instaphotos");
    assert.equal(instagram.length,9,'9 photos!')
    done();
  },5000) ;
});


// test('Dynamic searches', function(assert) {
//     var done = assert.async();
//     setTimeout (function(){
//     var instagram = document.getElementsByClassName("instaphotos");
//     assert.equal(instagram.length,9,'9 photos!')
